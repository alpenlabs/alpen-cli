...
mod tests {
    ...
    use super::*;
    use crate::{
        bitcoin::persist::set_data_dir, constants::SEED_LEN, seed::Seed, settings::Settings,
    };

    use alpen_bitcoin_wallet::backend::{
        BitcoinBackend, BroadcastTxError, GetFeeRateError, InvalidFee, ScanError, SyncError,
        UpdateSender,
    };
    use async_trait::async_trait;
    use bdk_wallet::{
        KeychainKind,
        bitcoin::{ScriptBuf, Transaction},
        chain::{
            CheckPoint,
